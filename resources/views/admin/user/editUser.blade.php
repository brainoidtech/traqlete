        ...
        <div class="col-12">
            <div class="card table-sec card-flush h-xl-100"
                ...
                <div class="card-body p-0-0">
                    <form method="POST" action="{{ route('update-user-data',$user->id) }}" class="p-4 common-form">
                        @method('PUT')
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="name" class="form-control" id="ManagerName" value="{{ old('name',$user->name)}}" placeholder="Enter Name">
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="UserContact" class="col-form-label">Contact Number *</label>
                                <input type="text" class="form-control" id="ManagerContact" name="contact_number" value="{{ old('contact_number',$user->contact_number)}}" placeholder="Enter Contact Number">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-12 col-md-6">
                                <label for="UserEmail" class="col-form-label">Email *</label>
                                <input type="email" class="form-control" id="ManagerEmail" placeholder="Enter Email" name="email" value="{{ old('email', $user->email)}}">
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="UserPassword" class="col-form-label">Password </label>
                                <input type="password" class="form-control" id="ManagerPassword" name="password" placeholder="Enter Password">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="card-body p-0-0">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-center py-3 px-2">
                                    ...
                                    <a class="btn btn-outline-warning me-md-2 border border-warning dcg-btn" href="{{ route('user-list')}}"
                                        type="button" style="padding:8px 35px;">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
